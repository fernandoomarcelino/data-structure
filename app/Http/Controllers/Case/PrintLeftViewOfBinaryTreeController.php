...
use Core\Case\PrintLeftViewOfBinaryTree\InputDto;
use Core\Case\PrintLeftViewOfBinaryTree\UseCase;
use Core\Geral\FactoryTree;
use Illuminate\Http\Response;

class PrintLeftViewOfBinaryTreeController extends Controller
{
